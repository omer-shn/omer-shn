...
public class Lists01 {
    ...
    public static void main(String[] args) {
        ...
        //2.WAY
        al1.add(1, 99); // 1.indexe (yani 2. sıraya) 99 sayısını koyar
        System.out.println(al1); //Eğer aynı indexte başka elemnt varsa onun yerini alır.

        //how to get the number of elementes
        int numEl = al1.size();
        System.out.println(numEl); // 4 verir

        System.out.println(al2.size()); //0

        // how to check if an ArrayList empty or not
        ...
        //how to check if an ArrayList is has just space
        ...
        //Create a String ArrayList add 5 elements
        ...
        // how to remove a spesific integer element from an integer list

        //1.Step create an Integer Wrapper Claas Object by using the value whish you want to remove
