...
public class Prac13Inheritance {
    int a = 12;
    public void rest(){
        System.out.println("XXX");
    }
    public Prac13Inheritance (){
        System.out.println("A");
    }
    public Prac13Inheritance (int a){
...
class Practice02 extends Prac13Inheritance {
    int a = 13;
    public void rest(){
...
class Runner{
    public static void main(String[] args) {
        ...
        System.out.println(obj2.a);//13 ==> If a class does not have "a" Java looks for "a" in parent classes. If any parent does not have "a" you will get Compile Time Error
        obj2.rest();//ZZZ

        Prac13Inheritance obj3 = new Practice03("Woow!");
