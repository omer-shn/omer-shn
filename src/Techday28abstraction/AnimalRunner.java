...
public class AnimalRunner {
    public static void main(String[] args) {
        ...
        Animal animal2 = new Sheep("mee","Shaun");
        animal2.animalSound();
        animal2.animalName();

        System.out.println("==============");

        Sheep sheep =new Sheep("baa","Dolly"); //This time used itself class
        System.out.println(sheep.name); // from itself class
        System.out.println(sheep.sound);// from itself class
        sheep.animalName();
        sheep.animalSound();

        //Differences between an abstract and a concreate class;
        //Abstract classes cannot generate any object, we can create objects from Concrete classes
        //Abstract classes have both abstract and cconcrete methods, but concrete class just can have concrete methods
